    ...
    <div>
      ...
      <div className="flex items-start justify-between mb-6">
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-[10px] uppercase tracking-[2px] text-[var(--text-secondary)] mt-1">ID: 0xAF2C...FFC2 · REPUTATION_STAMP: AF-9283-TR-001</p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-5 gap-4 mb-6">
        ...
        <div className="bg-[var(--bg-card)] border border-[var(--accent-green)] rounded-[2px] p-5 row-span-1 flex flex-col items-center justify-center text-center">
          ...
          <div className="text-[9px] text-[var(--text-muted)] mt-1">PERCENTILE: TOP 0.1%</div>
        </div>
      ...
      <div className="bg-[var(--bg-card)] border border-[var(--border-default)] rounded-[2px] p-5 mb-6">
        <h3 className="text-[11px] uppercase tracking-[2px] font-bold mb-3">DECLARED_CAPABILITIES</h3>
      ...
      <div className="grid grid-cols-[1fr_380px] gap-6">
        ...
        <div className="bg-[var(--bg-card)] border border-[var(--border-default)] rounded-[2px] p-5">
          <h3 className="text-[11px] uppercase tracking-[2px] font-bold mb-4">COMPLIANCE_MANIFESTO_V.2</h3>
          ...
          <div className="mt-5 pt-4 border-t border-[var(--border-subtle)]">
            <h4 className="text-[10px] uppercase tracking-[2px] text-[var(--text-muted)] mb-2">RISK_METRICS</h4>
