...
export function AttackSimulator() {
  ...
  return (
    <div className="rounded border border-[#1a1a1a] bg-[#0d0d0d] p-5">
      ...
      <div className="mb-5 space-y-2 font-mono text-[10px] leading-relaxed text-[#555]">
      ...
      <div className="flex gap-2">
        <button
          ...
          disabled={isRunning}
          className="flex flex-1 items-center justify-center gap-2 rounded bg-[#ff4444] py-2.5 font-mono text-[10px] font-bold tracking-wider text-white transition-colors hover:bg-[#ff4444]/80 disabled:opacity-50"
        >
        ...
        <button
          onClick={handleReset}
          className="rounded border border-[#1a1a1a] bg-[#111] px-3 py-2.5 text-[#555] transition-colors hover:text-white"
        >
