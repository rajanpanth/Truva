      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-8 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="font-mono text-[10px] tracking-widest text-[#555]">REPUTATION_STAMP_ID: AF-9283-TR-001</p>
          </div>
        </div>
        ...
        <div className="mb-8 grid grid-cols-2 gap-4 lg:grid-cols-4">
          {[
            ...
            <div key={m.label} className="rounded border border-[#1a1a1a] bg-[#0d0d0d] p-5">
              <p className="mb-1 font-mono text-[10px] tracking-widest text-[#555]">{m.label}</p>
              <p className="font-mono text-3xl font-bold text-white">{m.value}</p>
              <div className="mt-2 h-0.5 w-full bg-[#00ff88]/30">
                <div className="h-full bg-[#00ff88]" style={{ width: '100%' }} />
              </div>
            </div>
          ))}
          <div className="rounded border border-[#1a1a1a] bg-[#0d0d0d] p-5 text-center">
            <Shield className="mx-auto mb-2 h-10 w-10 text-[#00ff88]" />
            <p className="font-mono text-[10px] tracking-widest text-[#555]">STAKED_REPUTATION</p>
            <p className="font-mono text-2xl font-bold text-[#00ff88]">500,000 TRU</p>
          </div>
        </div>

        {/* Compliance manifesto */}
        <div className="rounded border border-[#1a1a1a] bg-[#0d0d0d] p-6">
          ...
          <div className="grid grid-cols-2 gap-y-4 md:grid-cols-4">
            <div>
              <p className="font-mono text-[10px] text-[#555]">KYC_STATUS</p>
              <p className="font-mono text-sm font-bold text-[#00ff88]">VERIFIED</p>
            </div>
            <div>
              <p className="font-mono text-[10px] text-[#555]">OPERATING_LIMIT</p>
              <p className="font-mono text-sm font-bold text-white">$18.8M DAILY</p>
            </div>
            <div>
              <p className="font-mono text-[10px] text-[#555]">JURISDICTION</p>
              <p className="font-mono text-sm font-bold text-white">GLOBAL_MESH</p>
            </div>
            <div>
              <p className="font-mono text-[10px] text-[#555]">LAST_AUDIT</p>
        ...
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-2">
          ...
          <div>
            ...
            <div className="space-y-5">
              <div>
                <label className="mb-1 block font-mono text-[10px] tracking-widest text-[#555]">AGENT_ENTITY_NAME</label>
                <input
                  type="text"
                  placeholder="e.g. ALPHA_LIQUIDITY_BOT"
                  className="w-full rounded border border-[#222] bg-[#111] px-4 py-3 font-mono text-xs text-white placeholder:text-[#333] focus:border-[#00ff88] focus:outline-none"
                />
              </div>
              <div>
                <label className="mb-1 block font-mono text-[10px] tracking-widest text-[#555]">PUBLIC_KEY_HEX (ED25519)</label>
                <input
                  type="text"
                  placeholder="0x..."
                  className="w-full rounded border border-[#222] bg-[#111] px-4 py-3 font-mono text-xs text-white placeholder:text-[#333] focus:border-[#00ff88] focus:outline-none"
              ...
              <div>
                <label className="mb-1 block font-mono text-[10px] tracking-widest text-[#555]">DEPLOYMENT_CATEGORY</label>
                <div className="relative">
                  <select className="w-full appearance-none rounded border border-[#222] bg-[#111] px-4 py-3 font-mono text-xs text-white focus:border-[#00ff88] focus:outline-none">
          ...
          <div>
            <div className="rounded border border-[#1a1a1a] bg-[#0d0d0d] p-6">
                ...
                {tiers.map((tier) => (
                  <div key={tier.name} className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-mono text-[10px] text-[#444]">{tier.desc}</p>
                    </div>
              ...
              <div className="mt-8 rounded border border-[#222] bg-[#111] p-4">
                <p className="font-mono text-[10px] leading-relaxed text-[#555]">
